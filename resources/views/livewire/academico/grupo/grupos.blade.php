            ...
            <table class=" text-sm text-left text-gray-500 dark:text-gray-400">
                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                        ...
                        <th scope="col" class="px-6 py-3" style="cursor: pointer;" wire:click="organizar('start_date')">
                            Inicia Grupo
                            @if ($ordena != 'start_date')
                                <i class="fas fa-sort"></i>
                            @else
                                @if ($ordenado=='ASC')
                                    <i class="fas fa-sort-up"></i>
                        ...
                        <th scope="col" class="px-6 py-3" style="cursor: pointer;" wire:click="organizar('finish_date')">
                            Finaliza Grupo
                            @if ($ordena != 'finish_date')
                                <i class="fas fa-sort"></i>
                            @else
                                @if ($ordenado=='ASC')
                                    <i class="fas fa-sort-up"></i>
