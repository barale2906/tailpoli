        ...
        <div class="flex p-4 text-sm text-green-800 rounded-lg bg-green-100 dark:bg-gray-800 dark:text-green-400" role="alert">
            ...
            <div>
                ...
                <div class="grid sm:grid-cols-1 md:grid-cols-6 gap-4 m-2">
                    ...
                    @if ($actual)
                        <div>
                            <a href="#" wire:click.prevent="$dispatch('Asistiendo')" class="text-black bg-gradient-to-r from-cyan-300 via-cyan-400 to-cyan-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-200 dark:focus:ring-cyan-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 capitalize">
