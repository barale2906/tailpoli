<div>
    @if ($fin)
        @if ($crt)
            ...
            <div class="grid grid-cols-2 gap-3 bg-slate-300 m-3 p-3">
                <div class="grid grid-cols-4 gap-3 m-1 p-1">
                    ...
                    @else
                        <label for="precio" class="block mb-2 text-xl font-medium text-gray-900 dark:text-white uppercase">
        ...
        <div class="grid sm:grid-cols-1 md:grid-cols-4 gap-4 m-2">
            @if ($movimientos)
                <a href="" wire:click.prevent="new()" class="text-black bg-gradient-to-r from-blue-300 via-blue-400 to-blue-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-200 dark:focus:ring-blue-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 capitalize">
