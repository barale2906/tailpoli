    ...
    <form wire:submit.prevent="new">
        ...
        @if ($pais && $states->count()>0)
            <div class="mb-6">
                ...
                <select wire:click="depart($event.target.value)" id="countries" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        @if ($depto && $ciudades->count()>0)
            <div class="mb-6">
                <label for="depto" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Población - Ciudad</label>
                <select wire:click="poblacion($event.target.value)" id="countries" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
        ...
        @if ($pobla)
            ...
            <div class="mb-6">
                <label for="portfolio_assistant_phone" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Teléfono de la sede</label>
