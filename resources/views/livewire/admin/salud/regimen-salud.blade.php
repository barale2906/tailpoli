<div>
    @if ($is_modify)
        <div class="flex justify-end mb-4 ">
            <a href="#" wire:click.prevent="$toggle('is_creating')" class="text-black bg-gradient-to-r from-green-400 via-green-500 to-green-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-green-300 dark:focus:ring-green-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 capitalize" >
    ...
    @if ($is_creating)
        <form wire:submit.prevent="newRegimen">
            ...
            <a href="#" wire:click.prevent="$toggle('is_creating')" class="text-black bg-gradient-to-r from-red-300 via-red-400 to-red-500 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-red-200 dark:focus:ring-red-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 capitalize">
